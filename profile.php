          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="main-profile ">
                <div class="row">
                  <div class="col-lg-4">
                    <img src="assets/images/profilna.jpg" alt="" style="border-radius: 20px;">
                  </div>
                  ...
                  <div class="col-lg-4 align-self-center">
                    <ul>
                      <li>Books Downloaded <span>29</span></li>
                      <li>Friends Online <span>17</span></li>
                      <li>Books Completed <span>21</span></li>
                      <li>Challenges <span>3</span></li>
                    </ul>
                  </div>
                </div>
              </div>
